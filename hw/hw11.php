...
if(isset($_GET['t'])) {
	...
	try {
		CLatexTemplate::download($data, $url.'latex/hw11/hw8_'.$hw.'.tex', $name.'_HW10.pdf');
    $date       = date('Y-m-d H:i:s');
    $quy2="INSERT INTO download (moodleid,time, download, hw) VALUES ('".$moodleid."','".$date."','pdf".$hw."',  '11')";
    mysql_query($quy2);
	} catch(Exception $e) {
		echo $e -> getMessage();
	}
        ...
        <div class="panel-body">
          ...
          <ul>
              ...
              <li>上傳規定：
                  ...
                  <li>本次作業請交：學號.ipynb</li>                                                   
                  <li>檔案請放進資料夾，使用zip壓縮。</li>                                                                                    
                  <li>檔名：<strong>學號_HW11.zip</strong></li>               
                  </ul>
              </li>
              <li><h3>期限：2016-12-22 17:10</h3></li>
              <li>
              其他注意事項：              
                  <ul>
