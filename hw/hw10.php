...
if(isset($_GET['t'])) {
	...
	try {
		CLatexTemplate::download($data, $url.'latex/hw10/hw8_'.$hw.'.tex', $name.'_HW10.pdf');
    $date       = date('Y-m-d H:i:s');
    $quy2="INSERT INTO download (moodleid,time, download, hw) VALUES ('".$moodleid."','".$date."','pdf".$hw."',  '10')";
    mysql_query($quy2);
	} catch(Exception $e) {
		echo $e -> getMessage();
	}
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <ul>
              ...
              <li><h3>期限：2016-12-15 17:00</h3></li>
              <li>
              其他注意事項：              
                  <ul>
